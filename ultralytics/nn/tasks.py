...
from ultralytics.nn.modules import (AIFI, C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x,
                                    ...
                                    Focus, GhostBottleneck, GhostConv, HGBlock, HGStem, Pose, RepC3, SPDConv,
...
from ultralytics.nn.CFFAttention import CFFAttention
from ultralytics.nn.FMBmodule import FMBmodule
from ultralytics.nn.SPPFCSPC import SPPFCSPC
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x, RepC3,ECAAttention, CFFAttention,FMBmodule, SPDConv):
            c1, c2 = ch[f], args[0]
        ...
        elif m in {SEAttention, ShuffleAttention}:
            args = [ch[f], *args]
        elif m in {SPPFCSPC}:
            c1, c2 = ch[f], args[0]
